...
- **Release builds**: A single `kalinka-vX.Y.Z` tag versions this plugin together with the server and the other first-party plugins (the SDK is versioned separately via `kalinka-plugin-sdk-v*`)
