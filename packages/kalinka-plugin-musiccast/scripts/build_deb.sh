...
PLUGIN_SLUG="kalinka-plugin-musiccast"
...
if [ ! -f "src/kalinka_plugin_musiccast/_version.py" ]; then
...
from kalinka_plugin_musiccast._version import __version__
print(__version__)
")

PLUGIN_WHEEL="kalinka_plugin_musiccast-${VERSION}-py3-none-any.whl"
