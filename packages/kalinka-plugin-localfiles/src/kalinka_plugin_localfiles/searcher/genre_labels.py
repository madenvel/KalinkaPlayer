"""
Discogs400 genre labels — index matches the model output activations.

Source: genre_discogs400-discogs-effnet-1.json from essentia.upf.edu
Format: "TopGenre---SubGenre"
"""

DISCOGS400_LABELS: list[str] = [
    "Blues---Boogie Woogie",
    "Blues---Chicago Blues",
    "Blues---Country Blues",
    "Blues---Delta Blues",
...
def label_for_index(idx: int) -> str:
    """Return the human-readable label for a Discogs400 index.

    Returns the full "TopGenre---SubGenre" label, lowercased.
    Falls back to "unknown_<idx>" if out of range.
    """
    if 0 <= idx < len(DISCOGS400_LABELS):
        return DISCOGS400_LABELS[idx].lower()
