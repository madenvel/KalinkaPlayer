...
PLUGIN_SLUG="{{ cookiecutter.plugin_name }}"
...
if [ ! -f "src/{{ cookiecutter.plugin_id }}/_version.py" ]; then
...
from {{ cookiecutter.plugin_id }}._version import __version__
print(__version__)
")

PLUGIN_WHEEL="{{ cookiecutter.plugin_id }}-${VERSION}-py3-none-any.whl"
