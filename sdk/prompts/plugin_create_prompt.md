...
* Entry point:
  ...
  {{package_name}} = "{{package_name}}.plugin:setup"
  ```
* Build system:
  ...
  ```
* Use `packages = [{ include = "{{package_name}}", from = "src" }]`.
...
# from kalinka_plugin_sdk.events import NowPlayingChanged  # example
